...
namespace KismetLogger
{
	public abstract class _Clients : SQLiteEntity
	{
		...
		//=================================================================
		public virtual bool LoadByPrimaryKey(string Bssid, string Clientmac)
		{
...
this.Where.Clientmac.Value = Clientmac;
		...
		protected class Parameters
		{
			...
			public static SQLiteParameter Clientdatasize
			{
				get
				{
					return new SQLiteParameter("@Clientdatasize", DbType.Decimal);
			...
			public static SQLiteParameter Clientpacketscrypt
			{
				get
				{
					return new SQLiteParameter("@Clientpacketscrypt", DbType.Decimal);
			...
			public static SQLiteParameter Clientpacketsdata
			{
				get
				{
					return new SQLiteParameter("@Clientpacketsdata", DbType.Decimal);
			...
			public static SQLiteParameter Clientpacketsweak
			{
				get
				{
					return new SQLiteParameter("@Clientpacketsweak", DbType.Decimal);
		...
		public virtual decimal Clientdatasize
	    {
			get
	        {
				return base.Getdecimal(ColumnNames.Clientdatasize);
			}
			set
	        {
				base.Setdecimal(ColumnNames.Clientdatasize, value);
			}
		}
		...
		public virtual decimal Clientpacketscrypt
	    {
			get
	        {
				return base.Getdecimal(ColumnNames.Clientpacketscrypt);
			}
			set
	        {
				base.Setdecimal(ColumnNames.Clientpacketscrypt, value);
			}
		}

		public virtual decimal Clientpacketsdata
	    {
			get
	        {
				return base.Getdecimal(ColumnNames.Clientpacketsdata);
			}
			set
	        {
				base.Setdecimal(ColumnNames.Clientpacketsdata, value);
			}
		}

		public virtual decimal Clientpacketsweak
	    {
			get
	        {
				return base.Getdecimal(ColumnNames.Clientpacketsweak);
			}
			set
	        {
				base.Setdecimal(ColumnNames.Clientpacketsweak, value);
			}
		}
		...
		public virtual string s_Clientdatasize
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.Clientdatasize) ? string.Empty : base.GetdecimalAsString(ColumnNames.Clientdatasize);
			}
			set
	        {
				if(string.Empty == value)
					...
					this.Clientdatasize = base.SetdecimalAsString(ColumnNames.Clientdatasize, value);
			}
		}
		...
		public virtual string s_Clientpacketscrypt
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.Clientpacketscrypt) ? string.Empty : base.GetdecimalAsString(ColumnNames.Clientpacketscrypt);
			}
			set
	        {
				if(string.Empty == value)
					...
					this.Clientpacketscrypt = base.SetdecimalAsString(ColumnNames.Clientpacketscrypt, value);
			}
		}
		...
		public virtual string s_Clientpacketsdata
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.Clientpacketsdata) ? string.Empty : base.GetdecimalAsString(ColumnNames.Clientpacketsdata);
			}
			set
	        {
				if(string.Empty == value)
					...
					this.Clientpacketsdata = base.SetdecimalAsString(ColumnNames.Clientpacketsdata, value);
			}
		}
		...
		public virtual string s_Clientpacketsweak
	    {
			get
	        {
				return this.IsColumnNull(ColumnNames.Clientpacketsweak) ? string.Empty : base.GetdecimalAsString(ColumnNames.Clientpacketsweak);
			}
			set
	        {
				if(string.Empty == value)
					...
					this.Clientpacketsweak = base.SetdecimalAsString(ColumnNames.Clientpacketsweak, value);
			}
		}
